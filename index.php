        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">ARSIP SURAT <span class="logo-dec">BNI DIVISI CLN</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="bagian/login"><i class="fa fa-sign-out pull-right"></i> Karyawan</a></li>
                  </ul>
                </li>
              </ul>
              </ul>
          ...
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <h3 class="bnr-sub-title">SISTEM INFORMASI PENGARSIPAN SURAT</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">BANK NEGARA INDONESIA DIVISI CLN</span></h3>
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Pengarsipan Surat Masuk dan Surat Keluar BNI Divisi CLN</p>
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; BNI CLN. All Rights Reserved.</p>
          <div class="credits">
            <!-- 
