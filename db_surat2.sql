...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2021 at 09:07 AM
...
CREATE TABLE `tb_suratmasuk` (
  ...
  `tanggalsurat_suratbalasan` date DEFAULT current_timestamp(),
...
(47, 'SURAT', '0003', 'SMG/5.1/2800/PMC/2021', '2021-10-04', 'USULAN HAPUS BUKU BNI FLEKSI OKTOBER 2021', '2021 USULAN HAPUS BUKU BNI FLEKSI OKTOBER 2021.pdf', 'SEKRETARIS JCM3', '2021-10-14 14:04:51', 'Bu Belinda ', '2021-10-14 14:04:00', '', '1970-01-01 07:00:00', ' ', '1970-01-01 07:00:00', 'CLN/11.2/6132', 'SURAT BALASAN USULAN HAPUS BUKU BNI FLEKSI OKTOBER 2021 KANTOR CABANG SEMARANG', '2021-11-10', 'BU GADIS & MBA NISA', 'DONE', 'Email', 'RA. GALUH JUNITASARI, NUR ANISA IRIANI, HENDRA NUR'),
(48, 'MEMO', '0004 ', 'CLN/6/5724', '2021-09-21', 'PELAKSANAAN HAPUS BUKU DEBITUR FLEKSI KERJASAMA BNI-TRAVELOKA CLEANSING PERIODE SEPTEMBER 2021 (STA)', '2021 PELAKSANAAN HAPUS BUKU DEBITUR FLEKSI KERJASAMA BNI-TRAVELOKA CLEANSING PERIODE SEPTEMBER 2021 (STA).pdf', 'SEKRETARIS JCM3', '2021-10-14 15:48:49', ' ', '1970-01-01 07:00:00', '', '1970-01-01 07:00:00 ', ' ', '1970-01-01 07:00:00', 'CLN/11.2/5752', 'PELAKSANAAN HAPUS BUKU DEBITUR FLEKSI KERJSAMA BNI-TRAVELOKA CLEANSING PERIODE SEPT 2021', '2021-09-22', '', 'DONE', 'Whatapp', ''),
(52, 'SURAT', '0005 ', 'CLN/11.2/5977', '2021-10-18', 'ADA', '2021 ADA.pdf', 'SEKRETARIS JCM3', '2021-10-18 13:59:32', ' ', '1970-01-01 07:00:00', '', '1970-01-01 07:00:00 ', ' ', '1970-01-01 07:00:00', '', '', '2021-10-18', '', '', '', '');
...
--
ALTER TABLE `tb_suratmasuk`
  MODIFY `id_suratmasuk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
COMMIT;
