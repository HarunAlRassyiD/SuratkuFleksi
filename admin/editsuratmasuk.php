                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="proses/proses_editsuratmasuk.php" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            $tanggalsurat_suratbalasan = $data['tanggalsurat_suratbalasan'];
                            $tanggalsurat_suratbalasan = date('m-d-Y', strtotime($tanggalsurat_suratbalasan));
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php $kosu = trim( $data['nomorurut_suratmasuk']) ;
                            echo $kosu?>"  type="text"  id="nomorurut_suratmasuk" name="nomorurut_suratmasuk" required="required" readonly="readonly"  maxlength="4" placeholder="Masukkan Nomor Urut Surat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Jenis Surat <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <label for="kode_suratmasuk">  </label>
                            <select name="kode_suratmasuk" id="kode_suratmasuk" class="form-control col-md-7 col-xs-12">
                              <option value="<?php echo $data['kode_suratmasuk']; ?>"><?php echo $data['kode_suratmasuk'];?> </option>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nomor Surat Masuk <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tanggal Surat Masuk <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <fieldset>
                          <div class="control-group">
                            <div class="controls">
                                <input value="<?php echo "$tgl_surat" ?>" type="text" class="form-control has-feedback-left" id="single_cal3" name="tanggalsurat_suratmasuk" placeholder="First Name" aria-describedby="inputSuccess2Status3" required="required">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Perihal Surat Masuk <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Melalui </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nomor Surat Balasan 
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['nomor_suratbalasan'];?>" type="text" id="nomor_suratbalasan" name="nomor_suratbalasan" maxlength="35" placeholder="Masukkan Nomor Surat Balasan" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tanggal Surat Balasan
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <fieldset>
                          <div class="control-group">
                            <div class="controls">
                                <input value="<?php echo "$tanggalsurat_suratbalasan" ?>" type="text" class="form-control has-feedback-left" id="single_cal3" name="tanggalsurat_suratbalasan" placeholder="First Name" aria-describedby="inputSuccess2Status3">
                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                <span id="inputSuccess2Status3" class="sr-only">(success)</span>
                            </div>
                          </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Perihal Surat Balasan
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea id="perihal_suratbalasan" name="perihal_suratbalasan"  class="form-control" rows="3" placeholder='Masukkan Perihal Surat Balasan'><?php echo $data['perihal_suratbalasan'];?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['disp_lanjut'];?>" type="text" id="disp_lanjut" name="disp_lanjut"  placeholder="To" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Follow Up Status
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['status_suratmasuk'];?>" type="text" id="status_suratmasuk" name="status_suratmasuk"  placeholder="Status Surat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Pengirim melalui 
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <label for="pengiriman_suratbalasan">  </label>
                            <select name="pengiriman_suratbalasan" id="pengiriman_suratbalasan" class="form-control col-md-7 col-xs-12">
                            <option value="<?php echo $data['pengiriman_suratbalasan']; ?>"><?php echo $data['pengiriman_suratbalasan'];?> </option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['nama_penerima_suratbalasan'];?>" type="text" id="nama_penerima_suratbalasan" name="nama_penerima_suratbalasan"  placeholder="Penerima" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <br><br>
                      <div class="form-group">
...
function validAngka(a)
{
	if(!/^[0-9.]+$/.test(a.value))
	{
	a.value = a.value.substring(0,a.value.length-10000);
	}
}
</script>
  </body>
