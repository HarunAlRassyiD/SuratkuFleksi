                  ...
                  <div class="x_content">
                    ...
                    <form action="proses/proses_editsuratkeluar.php" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">NO <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php $kosu = trim( $data['nomorurut_suratkeluar']) ;
                            echo $kosu?>"  type="text"  id="nomorurut_suratkeluar" name="nomorurut_suratkeluar" required="required" readonly="readonly"  maxlength="4" placeholder="Masukkan Nomor Urut Surat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tanggal Keluar Surat <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <div class='input-group date' id='myDatepicker4'>
                            <input value="<?php echo "$tgl_keluar" ?>" type='text' id="tanggalkeluar_suratkeluar" name="tanggalkeluar_suratkeluar" required="required" class="form-control" required="required" />
                      ...
                      <div class="form-group">
                        ...
                        <label for="kode_suratmasuk">  </label>
                            <select name="kode_suratkeluar" id="kode_suratkeluar" class="form-control col-md-7 col-xs-12">
                              <option value="<?php echo $data['kode_suratkeluar']; ?>"><?php echo $data['kode_suratkeluar'];?> </option>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nomor Surat Keluar<span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Tujuan Surat <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         <input name="file_suratkeluar" accept="application/pdf" type="file" id="file_suratkeluar" class="form-control" autocomplete="off"/><a href= "<?php echo 'surat_keluar/'.$data['file_suratkeluar'].''?>"><b>Lihat File Sebelumnya</b></a></input> (Maksimal 10 MB )
                        </div>
                      </div>
