        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-bank"></i> <span> Arsip Surat</span></a>
            </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-users"></i> Karyawan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dataadmin.php"><i class="fa  fa-inbox"></i>Data Admin</a></li>
                      <li><a href="databagian.php"><i class="fa  fa-inbox"></i>Data Karyawan</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
