                  ...
                  <div class="x_content">
                    ...
                    <!-- <div class="form-group">
                      ...
                      <?php include '../koneksi/koneksi.php';
                          ...
                          $nomor = trim($data['nomorurut_suratmasuk']);
                          
                          
                          if ($jumlah =0){
                            $nomorbaru = "0001";
                          } else {
                            $nomorbaru = str_pad(++$nomor, 4, '0', STR_PAD_LEFT);
                            }
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo "$nomorbaru" ?>" type="text" onkeyup="validAngka(this)" id="nomorurut_suratmasuk" name="nomorurut_suratmasuk" required="required" readonly="readonly" maxlength="4" placeholder="Masukkan Nomor Urut Surat" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <fieldset>
                          <div class="control-group">
                            <div class="controls">
                                <input type="text" class="form-control has-feedback-left" id="single_cal3" name="tanggalsurat_suratmasuk" placeholder="First Name" aria-describedby="inputSuccess2Status3" required="required" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="nomor_suratbalasan" name="nomor_suratbalasan"  maxlength="35" placeholder="Masukkan Nomor Surat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <fieldset>
                          <div class="control-group">
                            <div class="controls">
                                <input type="text" class="form-control has-feedback-left" id="single_cal4" name="tanggalsurat_suratbalasan" placeholder="First Name" aria-describedby="inputSuccess2Status4"  >
                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea id="perihal_suratbalasan" name="perihal_suratbalasan"  class="form-control" rows="3" placeholder='Masukkan Perihal Surat'></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="disp_lanjut" name="disp_lanjut"  placeholder="To" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="status_suratmasuk" name="status_suratmasuk"  placeholder="Masukan Follow Up Status" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       <!-- <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Pengirim melalui <span>*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Instansi Penerima 
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="nama_penerima_suratbalasan" name="nama_penerima_suratbalasan"  placeholder="Masukkan Instansi Penerima" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
