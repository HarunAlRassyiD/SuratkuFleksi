          ...
          <div class="">
            <div class="page-title">
              <div class="title_right">
                <h2>Karyawan > <small>Data Karyawan</small></h2>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <a href="inputbagian.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Karyawan</button></a>
                  <div class="x_content">
                  <div class="x_content">
                             <?php
                              ...
                              if ($total == 0) {
                                echo"<center><h2>Belum Ada Data Karyawan</h2></center>";
                              }
                              else{?>
