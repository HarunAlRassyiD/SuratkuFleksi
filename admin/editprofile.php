            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form action="proses/proses_editprofile.php" method="post" enctype="multipart/form-data" name="updateadmin" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['nama_admin'];?>" type="text" id="nama_admin" name="nama_admin" required="required" maxlength="70"  placeholder="Masukkan Nama Lengkap" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['username_admin'];?>" type="text" id="username_admin" name="username_admin" required="required" maxlength="50" placeholder="Masukkan Username Admin" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
