                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php include '../koneksi/koneksi.php';
                          $sql2 		= "SELECT * FROM tb_suratkeluar ORDER BY nomorurut_suratkeluar DESC LIMIT 1" ;  
                          $query2  	= mysqli_query($db, $sql2);
                          $data     = mysqli_fetch_array($query2);
                          $jumlah   = mysqli_num_rows($query2);
                          $nomor = trim($data['nomorurut_suratkeluar']);
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo "$nomorbaru" ?>" type="text" onkeyup="validAngka(this)" id="nomorurut_suratkeluar" name="nomorurut_suratkeluar" required="required" readonly="readonly" maxlength="4" placeholder="Masukkan Nomor Urut Surat" class="form-control col-md-7 col-xs-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <label for="kode_suratkeluar">  </label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="nomor_suratkeluar" name="nomor_suratkeluar" required="required" maxlength="35" placeholder="Masukkan Nomor Surat" class="form-control col-md-7 col-xs-12">
