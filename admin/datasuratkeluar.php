                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th width="4%">NO</th>
                          <th width="15%">TANGGAL KELUAR SURAT</th>
                          <th width="15%">JENIS SURAT</th>
                          <th width="15%">NO SURAT KELUAR</th>
                          <th width="15%">TANGGAL SURAT KELUAR</th>
                          <th width="15%">PERIHAL SURAT KELUAR</th>
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query1)){
                              ...
                              <td>	'. $data['nomorurut_suratkeluar'].'	</td>
