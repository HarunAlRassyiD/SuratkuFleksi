            ...
            <div class=table-responsive panel>
              <div class="col-md-2 col-sm-2 col-xs-2">
                <div class="x_panel">
                  ...
                  <a href="inputadmin.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Admin</button></a>
                  <div class="x_content">
                  <div class="x_content">
                             <?php
                              include '../koneksi/koneksi.php';
                              $sql1  		= "SELECT * FROM tb_admin order by id_admin asc";                        
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th width="10%">Username Admin</th></tr>
                      </thead>
